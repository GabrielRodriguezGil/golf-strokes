...
/**
 * Representa un recorrido de golf y gestiona los golpes realizados por cada
 * jugador.
 * Utiliza una estructura de datos Table para almacenar el número de golpes de
 * cada jugador
 * en cada hoyo, donde:
...
class Course {
    ...
    /**
     * Añade o actualiza el registro de recorrido de un jugador con sus golpes en
     * cada hoyo.
     * 
     * @param player       El jugador cuyo registro de recorrido se está añadiendo
     * @param playerCourse Array de golpes para cada hoyo, donde el índice
     *                     representa el número de hoyo (base 0)
     */
